 ...
 *
 * <p>The actual {@link #getOrder() order} can be interpreted as prioritization（优先次序）,
...
public interface Ordered {
	...
	/**
	 * Useful constant for the highest precedence（优先权）value.
	 ...
	 * <p>Same order values will result in arbitrary（任意的）sort positions for the
	 * affected objects.
