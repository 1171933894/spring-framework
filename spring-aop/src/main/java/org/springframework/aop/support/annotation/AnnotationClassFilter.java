...
public class AnnotationClassFilter implements ClassFilter {
	...
	private final boolean checkInherited;// inherited：遗传
	...
	public boolean matches(Class<?> clazz) {
		return (this.checkInherited ? /*继承的注解也会找出来*/AnnotatedElementUtils.hasAnnotation(clazz, this.annotationType) :
				/*只会看自己本类的注解*/clazz.isAnnotationPresent(this.annotationType));
	}
